...
import { X, FileText, Download, Printer, Bot, CheckCircle, AlertTriangle, ZoomIn, ZoomOut, ChevronDown } from "lucide-react";
...
export default function DocumentDetailModal({ submission, open, onOpenChange }: Props) {
          ...
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500 mt-0.5">
                <span>Uploaded on {submission.uploadDate} &bull; {submission.fileSize} {submission.fileType}</span>
                <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold ${config.badge}`}>
